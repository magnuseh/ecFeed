...
package com.testify.ecfeed.plugin.editor;
...
import com.testify.ecfeed.plugin.editor.modeleditor.ModelPage;
import com.testify.ecfeed.plugin.editor.sourceviewer.SourceViewer;

public class EcMultiPageEditor extends FormEditor{
	
	public static String ID = "com.testify.ecfeed.plugin.editor.EcMultiPageEditor";
